  ...
  In order to user this version, is important to follow next steps:
    * Go inside your database using `sudo -u postgres psql peertube_prod` and run:
     ...
     * Maybe, you will need also to run: `GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO peertube;`
     ...
     `INSERT INTO "premiumStoragePlan" ("name", "quota", "dailyQuota", "priceTube", "duration", "createdAt", "updatedAt" ) VALUES ('250 GB', 268435456000, 26843545600, 250.250, 2678400000, now(), now());`
     `INSERT INTO "premiumStoragePlan" ("name", "quota", "dailyQuota", "priceTube", "duration", "createdAt", "updatedAt" ) VALUES ('500 GB', 536870912000, 53687091200, 500.500, 2678400000, now(), now());`
     `INSERT INTO "premiumStoragePlan" ("name", "quota", "dailyQuota", "priceTube", "duration", "createdAt", "updatedAt" ) VALUES ('1 TB', 1099511627776, 09951162777, 1024.1024, 2678400000, now(), now());`
     `INSERT INTO "premiumStoragePlan" ("name", "quota", "dailyQuota", "priceTube", "duration", "createdAt", "updatedAt" ) VALUES ('2.5 TB', 2748779069440, 274877906944, 2048.2048, 2678400000, now(), now());`
     `INSERT INTO "premiumStoragePlan" ("name", "quota", "dailyQuota", "priceTube", "duration", "createdAt", "updatedAt" ) VALUES ('5 TB', 5497558138880, 549755813888, 5096.5096, 2678400000, now(), now());`
