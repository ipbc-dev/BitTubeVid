...
<<<<<<< Updated upstream:client/src/app/+my-account/my-account-videos/video-change-ownership/video-change-ownership.component.ts
...
import { NgbModal } from '@ng-bootstrap/ng-bootstrap'
>>>>>>> Stashed changes:client/src/app/+my-library/my-videos/modals/video-change-ownership.component.ts
