...
describe('Test a single server', function () {
    ...
    it('Should upload the video', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield extra_utils_1.uploadVideo(server.url, server.accessToken, videoAttributes);
    ...
    it('Should get and seed the uploaded video', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield extra_utils_1.completeVideoCheck(server.url, video, getCheckAttributes());
        });
    });
    ...
    it('Should filter by tags and category', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res2 = yield extra_utils_1.getVideosWithFilters(server.url, { tagsAllOf: ['tagup1', 'tagup2'], categoryOneOf: 3 });
    ...
    it('Should have the video updated', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield extra_utils_1.getVideo(server.url, videoId);
            const video = res.body;
            yield extra_utils_1.completeVideoCheck(server.url, video, updateCheckAttributes());
        });
    });
    it('Should update only the tags of a video', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield extra_utils_1.getVideo(server.url, videoId);
            const video = res.body;
            yield extra_utils_1.completeVideoCheck(server.url, video, Object.assign(updateCheckAttributes(), attributes));
        });
    });
    it('Should update only the description of a video', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield extra_utils_1.completeVideoCheck(server.url, video, expectedAttributes);
        });
    });
