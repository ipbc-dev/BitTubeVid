...
function runServers(numberOfServers) {
    return __awaiter(this, void 0, void 0, function* () {
        const servers = (yield extra_utils_1.flushAndRunMultipleServers(numberOfServers))
        ...
        for (let i = 0; i < numberOfServers; i++) {
            for (let j = 0; j < numberOfServers; j++) {
                if (i === j)
                    continue;
                yield extra_utils_1.follow(servers[i].url, [servers[j].url], servers[i].accessToken);
            }
        }
        return servers;
    });
...
function exitServers(servers, flushAtExit) {
    return __awaiter(this, void 0, void 0, function* () {
        extra_utils_1.killallServers(servers);
        if (flushAtExit)
            yield extra_utils_1.flushTests();
    });
}
function upload(servers, numServer) {
    ...
    return extra_utils_1.uploadVideo(servers[numServer].url, servers[numServer].accessToken, videoAttributes);
}
function update(servers, numServer) {
    return __awaiter(this, void 0, void 0, function* () {
        const res = yield extra_utils_1.getVideosList(servers[numServer].url);
        ...
        return extra_utils_1.updateVideo(servers[numServer].url, servers[numServer].accessToken, toUpdate, attributes);
    });
}
function remove(servers, numServer) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return extra_utils_1.removeVideo(servers[numServer].url, servers[numServer].accessToken, toRemove);
    });
}
function view(servers, numServer) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return extra_utils_1.viewVideo(servers[numServer].url, toView);
    });
}
...
function rate(servers, numServer, rating) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return extra_utils_1.getVideo(servers[numServer].url, toRate);
    });
}
function checkIntegrity(servers) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const server of servers) {
            const p = extra_utils_1.getVideosListPagination(server.url, 0, 1000000, '-createdAt')
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const server of servers) {
            for (const state of states) {
                const p = jobs_1.getJobsListPaginationAndSort({
                    url: server.url,
