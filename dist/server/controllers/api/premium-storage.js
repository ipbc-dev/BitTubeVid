...
premiumStorageRouter.post('/delete-plan', middlewares_1.authenticate, middlewares_2.ensureUserHasRight(0), middlewares_1.asyncMiddleware(adminDeletePlan));
premiumStorageRouter.post('/add-plan', middlewares_1.authenticate, middlewares_2.ensureUserHasRight(0), middlewares_1.asyncMiddleware(adminAddPlan));
premiumStorageRouter.post('/update-plan', middlewares_1.authenticate, middlewares_2.ensureUserHasRight(0), middlewares_1.asyncMiddleware(adminUpdatePlan));
