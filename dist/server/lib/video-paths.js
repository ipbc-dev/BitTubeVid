...
exports.getHLSDirectory = exports.getTorrentFilePath = exports.getTorrentFileName = exports.getVideoFilePath = exports.getVideoFilename = exports.generateWebTorrentVideoName = exports.generateVideoStreamingPlaylistName = void 0;
...
function getVideoFilePath(videoOrPlaylist, videoFile, isRedundancy = false) {
    if (videoFile.isHLS()) {
        const video = video_1.extractVideo(videoOrPlaylist);
        return path_1.join(getHLSDirectory(video), getVideoFilename(videoOrPlaylist, videoFile));
    }
