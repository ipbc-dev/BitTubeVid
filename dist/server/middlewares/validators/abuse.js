...
exports.videoAbuseListValidator = exports.videoAbuseUpdateValidator = exports.videoAbuseGetValidator = exports.videoAbuseReportValidator = exports.getAbuseValidator = exports.abuseListForUserValidator = exports.deleteAbuseMessageValidator = exports.abuseUpdateValidator = exports.checkAbuseValidForMessagesValidator = exports.addAbuseMessageValidator = exports.abuseGetValidator = exports.abuseReportValidator = exports.abuseListForAdminsValidator = void 0;
...
const videoAbuseUpdateValidator = [
    ...
    express_validator_1.body('state')
        .optional()
        .custom(abuses_1.isAbuseStateValid).withMessage('Should have a valid video abuse state'),
    express_validator_1.body('moderationComment')
        .optional()
        .custom(abuses_1.isAbuseModerationCommentValid).withMessage('Should have a valid video moderation comment'),
    (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
